...
using JahomProject.Sessions;
using JahomProject.Web.Controllers.Results;
using JahomProject.Web.Models;
using JahomProject.Web.Models.Account;
...
{
    public class AccountController : JahomProjectControllerBase
    {
